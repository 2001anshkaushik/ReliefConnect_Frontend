  ...
  const volunteerOpportunities = [
    {
      ...
      description: "Help manage emergency shelter operations, assist with check-ins, and provide support to displaced families.",
      icon: <HomeIcon />,
      color: "#2563eb"
    },
    {
      ...
      description: "Assist with sorting and distributing emergency food supplies to affected families.",
      icon: <RestaurantIcon />,
      color: "#059669"
    },
    {
      ...
      description: "Provide medical support and first aid assistance at mobile medical stations.",
    ...
    },
    {
      ...
      description: "Help coordinate communications between relief agencies and affected communities.",
      icon: <SchoolIcon />,
      color: "#7c3aed"
    }
  ];
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ mb: 4, textAlign: "center" }}>
        ...
        <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 600, mx: "auto" }}>
          Join the relief effort by volunteering your time or making a donation to support disaster recovery
        </Typography>
      </Box>
        ...
        <Grid container spacing={3}>
          {volunteerOpportunities.map((opportunity, index) => (
            <Grid item xs={12} md={6} key={index}>
              <Card className="card-elevated" sx={{ height: "100%" }}>
                <CardContent>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2 }}>
                    <Avatar sx={{ backgroundColor: opportunity.color, width: 48, height: 48 }}>
                      {opportunity.icon}
                    </Avatar>
                    <Box sx={{ flexGrow: 1 }}>
      ...
      <Box>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 3, maxWidth: 600 }}>
          Support relief efforts by donating to trusted organizations working on the ground to help affected communities.
        </Typography>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <option value="communication">Communication Coordinator</option>
      ...
      {volunteerSubmitted && (
        ...
        >
          Thank you for your interest in volunteering! We'll contact you within 24 hours with next steps.
        </Alert>
      )}
    </Container>
  );
